...
# In[3]:
#获取历史用户
add_new_code=con.query("SELECT ods_table_name,imei,visit_week,visit_month,visit_quarter,city_id,ods_id,'visit_date' FROM  dwb_db.dwb_customer_add_new_code where add_new_code = '0' and dr = '0' and visit_date < '"+start_time+"'")
