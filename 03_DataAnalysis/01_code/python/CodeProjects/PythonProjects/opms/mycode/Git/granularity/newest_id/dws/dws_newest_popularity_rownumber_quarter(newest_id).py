...
grouped['dr'] = 0
grouped = grouped[grouped['newest_id'].isin(newest_ids)]
...
# 建立链接游标
cur=connect_mysql(conn)
update_sql2 = "update dws_db_prd.dws_newest_popularity_rownumber_quarter set plush_house = 0 where period = '"+date_quarter+"' and plush_house is null "
