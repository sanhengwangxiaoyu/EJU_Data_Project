...
reult1 = pd.concat([df_zq,df_jn,df_wh,df_hz,df_gy,df_cd,df_wx,df_zb,df_xm,df_sheny,df_qd,df_hf,df_hk,df_dg,df_cs,df_jj,df_fs,df_nn,df_jx,df_sz,df_fz,df_sh])
...
reult2 = pd.concat([df_xy,df_wz,df_yz,df_xz,df_zh,df_sjz,df_nb,df_zs,df_nj,df_gz,df_cc,df_beij,df_bj,])
