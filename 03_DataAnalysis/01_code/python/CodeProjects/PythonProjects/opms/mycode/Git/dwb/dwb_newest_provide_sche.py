...
Created on Jul 12 17:44:47 2021
  清洗动态信息
"""
import configparser,os,sys,pymysql,pandas as pd,time,getopt,re
...
sche=con.query("select url,newest_name,sche_tag,case when provide_title='' then provide_sche else provide_title end provide_title,provide_date,case when provide_sche = '' then concat(provide_title,sche_tag) else provide_sche end provide_sche,date_clean,create_time,update_time,housing_id from odsdb.ori_newest_provide_sche where date_clean between '"+start_date+"' and '"+end_date+"'")
...
sche['provide_sche'] = sche['provide_sche'].apply(lambda x:re.sub("[， , . 。！ !][^， , . 。！ !]*咨[^， , . 。！ !]*[， , . 。！ !]", "", x))
sche['provide_sche'] = sche['provide_sche'].apply(lambda x:re.sub("[， , . 。！ !][^， , . 。！ !]*询[^， , . 。！ !]*[， , . 。！ !]", "", x))
sche['provide_sche'] = sche['provide_sche'].apply(lambda x:re.sub("[， , . 。！ !][^， , . 。！ !]*[， , . 。！ !][^， , . 。！ !]*\d{3}-\d{8}|\d{4}-\{7,8}[^， , . 。！ !]*[， , . 。！ !][^， , . 。！ !]*[， , . 。！ !]", "", x))
sche['provide_sche'] = sche['provide_sche'].apply(lambda x:re.sub("[， , . 。！ !][^， , . 。！ !]*等等[^， , . 。！ !]*[， , . 。！ !]", "", x))
sche['provide_sche'] = sche['provide_sche'].apply(lambda x:re.sub("[， , . 。！ !][^， , . 。！ !]*\.号楼[^， , . 。！ !]*[， , . 。！ !]", "", x))
sche['provide_sche'] = sche['provide_sche'].apply(lambda x:re.sub("[， , . 。！ !][^， , . 。！ !]*具体一房一价[^， , . 。！ !]*[， , . 。！ !]", "", x))
sche['provide_sche'] = sche['provide_sche'].apply(lambda x:re.sub("[， , . 。！ !][^， , . 。！ !]*以开发商公布为准[^， , . 。！ !]*[， , . 。！ !]", "", x))
sche['provide_sche'] = sche['provide_sche'].apply(lambda x:re.sub("[， , . 。！ !][^， , . 。！ !]*https[^， , . 。！ !]*[， , . 。！ !]", "", x))
sche['provide_sche'] = sche['provide_sche'].apply(lambda x:re.sub("[， , . 。！ !][^， , . 。！ !]*链家[^， , . 。！ !]*[， , . 。！ !]", "", x))
...
sche['provide_sche'] = sche['provide_sche'].apply(lambda x:re.sub("[， , . 。！ !][^， , . 。！ !]*咨[\s\S]*", "", x))
sche['provide_sche'] = sche['provide_sche'].apply(lambda x:re.sub("[， , . 。！ !][^， , . 。！ !]*询[\s\S]*", "", x))
sche['provide_sche'] = sche['provide_sche'].apply(lambda x:re.sub("[， , . 。！ !][^， , . 。！ !]*[， , . 。！ !][^， , . 。！ !]*\d{3}-\d{8}|\d{4}-\{7,8}[\s\S]*", "", x))
sche['provide_sche'] = sche['provide_sche'].apply(lambda x:re.sub("[， , . 。！ !][^， , . 。！ !]*等等[\s\S]*", "", x))
sche['provide_sche'] = sche['provide_sche'].apply(lambda x:re.sub("[， , . 。！ !][^， , . 。！ !]*\.号楼[\s\S]*", "", x))
sche['provide_sche'] = sche['provide_sche'].apply(lambda x:re.sub("[， , . 。！ !][^， , . 。！ !]*具体一房一价[\s\S]*", "", x))
sche['provide_sche'] = sche['provide_sche'].apply(lambda x:re.sub("[， , . 。！ !][^， , . 。！ !]*以开发商公布为准[\s\S]*", "", x))
sche['provide_sche'] = sche['provide_sche'].apply(lambda x:re.sub("[， , . 。！ !][^， , . 。！ !]*https[\s\S]*", "", x))
sche['provide_sche'] = sche['provide_sche'].apply(lambda x:re.sub("[， , . 。！ !][^， , . 。！ !]*链家*", "", x))
...
sche['provide_sche'] = sche['provide_sche'].apply(lambda x:re.sub("[\s\S]*咨[^， , . 。！ !]*[， , . 。！ !]", "", x))
sche['provide_sche'] = sche['provide_sche'].apply(lambda x:re.sub("[\s\S]*询[^， , . 。！ !]*[， , . 。！ !]", "", x))
sche['provide_sche'] = sche['provide_sche'].apply(lambda x:re.sub("[\s\S]*\d{3}-\d{8}|\d{4}-\{7,8}[^， , . 。！ !]*[， , . 。！ !][^， , . 。！ !]*[， , . 。！ !]", "", x))
sche['provide_sche'] = sche['provide_sche'].apply(lambda x:re.sub("[\s\S]*等等[^， , . 。！ !]*[， , . 。！ !]", "", x))
sche['provide_sche'] = sche['provide_sche'].apply(lambda x:re.sub("[\s\S]*\.号楼[^， , . 。！ !]*[， , . 。！ !]", "", x))
sche['provide_sche'] = sche['provide_sche'].apply(lambda x:re.sub("[\s\S]*具体一房一价[^， , . 。！ !]*[， , . 。！ !]", "", x))
sche['provide_sche'] = sche['provide_sche'].apply(lambda x:re.sub("[\s\S]*以开发商公布为准[^， , . 。！ !]*[， , . 。！ !]", "", x))
sche['provide_sche'] = sche['provide_sche'].apply(lambda x:re.sub("[\s\S]*https[^， , . 。！ !]*[， , . 。！ !]", "", x))
sche['provide_sche'] = sche['provide_sche'].apply(lambda x:re.sub("[\s\S]*链家[^， , . 。！ !]*[， , . 。！ !]", "", x))
...
sche['provide_sche'] = sche['provide_sche'].apply(lambda x:re.sub("&lt；", "", x))
sche['provide_sche'] = sche['provide_sche'].apply(lambda x:re.sub("展开", "", x))
sche['provide_sche'] = sche['provide_sche'].apply(lambda x:re.sub("收起", "", x))
sche['provide_sche'] = sche['provide_sche'].apply(lambda x:re.sub("欢迎来电[\s\S]*\d{1,9}-\d{1,9}-\d{1,9}转\d{1,9}|\d{3}-\d{8}|\d{4}-\d{7,8}|\d{11}", "", x))
...
sche['provide_sche'] = sche['provide_sche'].apply(lambda x:re.sub("^.包括", "。", x))
sche['provide_sche'] = sche['provide_sche'].apply(lambda x:re.sub("^[， , . 。！ ! ## # #、# ) ** * - -，. .. .]", "。", x))
sche['provide_sche'] = sche['provide_sche'].apply(lambda x:re.sub("[， , . 。！ ! ## # #、# ) ** * - -，. .. . 、.]$", "。", x))
# sche['provide_sche'] = sche['provide_sche'].apply(lambda x:re.sub("^\#", "。", x))
...
#区分数据来源
#数据来源为梁文广Q2季度爬取的动态
sche['sche_tag'] = '2021Q4'
df = sche[sche['create_time'] == '2021-08-17 14:22:36.0']
#数据为刚开始爬取的最原始数据
df02 = sche[sche['create_time'] != '2021-08-17 14:22:36.0']
...
# In[9]:
result = df.groupby(['provide_sche','newest_name','url'])['sche_tag','provide_title','date_clean'].max().reset_index()
...
result = result[result['provide_sche'] != '。。']
result = result[result['provide_title'] != '。。']
#针对正文进行去重
result = result.groupby(['period','url','newest_name','provide_sche'])['date_clean','provide_title'].max().reset_index()
#补充空的动态正文
...
result['provide_sche'] = result['provide_sche'].apply(lambda x:re.sub("。", ".", x))
