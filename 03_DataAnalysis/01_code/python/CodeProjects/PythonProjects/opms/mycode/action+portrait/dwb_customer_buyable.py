...
#                                                      education   教育水平
#                                                      have_child  有孩子
tag = con.query("select max(id) ods_id,'dwb_db.b_dwb_customer_imei_tag' ods_table_name, imei,'2021Q3' visit_quarter,0 buyable,0 dr,now() create_time,now() update_time from dwb_db."+input_table_name+" where is_college_stu = '否' and marriage = '已婚' and education = '高' and have_child = '有' group by imei")
