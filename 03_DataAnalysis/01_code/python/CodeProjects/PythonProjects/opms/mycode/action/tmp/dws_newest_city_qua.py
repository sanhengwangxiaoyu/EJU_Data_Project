...
Update on 2021-06-15 17:48
          ...
          不使用dws_customer_cre
       on 2021-07-16 10:48
          修改均值筛选规则，区域等于0的保留，值为空: 注释grouped1= grouped1[grouped1['unit_price']>0] 。添加result.at[result.unit_price == 0,'unit_price'] = ''
"""
import configparser
import os
import sys
...
table_name = 'dws_newest_city_qua'
...
# # ================================================添加城市的，上边是按照区域的================================================
# In[1000] :
result_test = result[result['county_id'] == '310115']
...
# grouped05_intention_tmp =  grouped5[grouped5['cre'] == '意向']
...
# grouped05_urgent_tmp =  grouped5[grouped5['cre'] == '迫切']
...
#  result.at[result.unit_price == 0,'unit_price'] = ''
#  dws_newest_city_qua
...
update_sql1 = "UPDATE dws_db."+table_name+" SET county_id = NULL WHERE county_id = 'NULL' OR county_id = ''"
cur.execute(update_sql1)
update_sq2 = "UPDATE dws_db."+table_name+" SET unit_price = NULL WHERE unit_price = 0"
