...
latlng_list='search_gps.txt'#待爬取数据文本有3列：new,addr,lat_lng 
outfile = 'latlng_rs.txt' #结果数据
keylog='keylog.txt' #日志
oklist = set()
urls=Queue()
keys=Queue()
...
def main():
    ...
    keylist=['61d7e8cf769016c6904b3cea7b719e3d',
    ...
    types = {
        ...
        '专科医院':[ '090200', '090201', '090202', '090203', '090204', '090205', '090206', '090207', '090208', '090209', '090210', '090211'],
