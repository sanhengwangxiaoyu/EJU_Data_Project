...
grouped5_intention_tmp =  grouped5[grouped5['cre'] == '意向']
...
grouped5_urgent_tmp =  grouped5[grouped5['cre'] == '迫切']
...
update_sql = "UPDATE dws_db."+table_name+" SET county_id = NULL WHERE county_id = 'NULL' OR county_id = ''"
