...
object ConsumePrefer {
  def main(args: Array[String]): Unit = {
    ...
    val querySQL1 =
      """
        |SELECT imei,consume_prefer,concat_ws ('',social_prefer,read_prefer,game_prefer,live_prefer,
      ...
      .apply(
        (l, f) => {
          ...
          (l._1, //imei
            ...
            if (f.getField(1) !=null &&f.getField(2) !="")"购物行为" else "", //social_prefer
