...
## update_sql1 = "insert into dws_db.dws_supply select city_name, county_name, county_id city_id, period, supply_value value, null local_issue_value , null local_room_sum_value, null cric_value, null value_from_index , null county_name_merge, '2' city_county_index, '1' period_index, now() update_time, 0 dr, now() create_time, intention follow_people_num, city_id cityid from dwb_db.dwb_issue_supply_county where period = '"+date_quarter+"' and dr = 0 union all select  city_name, city_name county_name, city_id city_id, period, sum(supply_value) value, null local_issue_value , null local_room_sum_value, null cric_value, null value_from_index , null county_name_merge, '1' city_county_index, '1' period_index, now() update_time, 0 dr, now() create_time, null follow_people_num, city_id cityid from dwb_db.dwb_issue_supply_county  where period = '"+date_quarter+"' and dr = 0  group by city_name,city_id,period"
# update_sql1 = "insert into dws_db_prd.dws_supply(city_name,county_name,city_id,period,value,local_issue_value,local_room_sum_value,cric_value,value_from_index,county_name_merge,city_county_index,period_index,update_time,dr,create_time,follow_people_num,cityid) select city_name, county_name, county_id city_id, period, supply_value value, null local_issue_value , null local_room_sum_value, null cric_value, null value_from_index , null county_name_merge, '2' city_county_index, '1' period_index, now() update_time, 0 dr, now() create_time, intention follow_people_num, city_id cityid from dwb_db.dwb_issue_supply_county where period = '"+date_quarter+"' and dr = 0 union all select  city_name, city_name county_name, city_id city_id, period, sum(supply_value) value, null local_issue_value , null local_room_sum_value, null cric_value, null value_from_index , null county_name_merge, '1' city_county_index, '1' period_index, now() update_time, 0 dr, now() create_time, null follow_people_num, city_id cityid from dwb_db.dwb_issue_supply_county  where period = '"+date_quarter+"' and dr = 0  group by city_name,city_id,period"
