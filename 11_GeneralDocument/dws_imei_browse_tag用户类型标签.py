...
#竞争关系-客户竞争指数
#imei标签-三度
ori=con.query(" SELECT city_id,newest_id,visit_date,imei, '"+period+"' period FROM dwb_db.dwb_customer_browse_log where visit_date>='"+start_date+"' and visit_date<'"+end_date+"' ")
